...
//
//        //Resend message
//        int sd = send(clientSocket, buf, bytesRecv + 1, 0); //Возвращает количество отправленных байт, если отправил меньше нужного - необходимо дослать
//        std::cout << "Sended bytes: " << sd << std::endl;
//    }
//
//    //Close socket
//    close(clientSocket);
